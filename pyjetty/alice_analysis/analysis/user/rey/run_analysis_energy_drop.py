...
################################################################
class RunAnalysisEnergyDrop(run_analysis.RunAnalysis):

  #---------------------------------------------------------------
  # Constructor
  #---------------------------------------------------------------
  def __init__(self, config_file='', **kwargs):
    super(RunAnalysisEnergyDrop, self).__init__(config_file, **kwargs)
...
if __name__ == '__main__':
  ...
  analysis = RunAnalysisEnergyDrop(config_file = args.configFile)
